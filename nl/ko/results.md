...
## Developer Insights 및 Team Dynamics 보고서

초기 데이터 마이닝 기간 후에 팀과 코드에 대한 대시보드를 볼 수 있습니다. 서비스 탐색 메뉴에서 **Developer Insights** 또는 **Team Dynamics**를 클릭한 다음 이 정보를 볼 데이터 카테고리를 선택하십시오.
