...
{{site.data.keyword.DRA_full}} Team utiliza un análisis de interacción para identificar el nivel de interacción entre los miembros del equipo para corregir prácticas improductivas en el equipo.
{:shortdesc}
