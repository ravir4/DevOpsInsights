...
{{site.data.keyword.DRA_full}} Team employs interaction analysis to identify the level of interaction between team members so that the team can fix unproductive practices.
{:shortdesc}
